		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ordersmngmtnspworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordersmngmtnspworkflowuimodule-display": {
								"semanticObject": "ordersmngmtnspworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordersmngmtnsp.workflowuimodule",
									"url": sap.ui.require.toUrl("ordersmngmtnsp/workflowuimodule")
								}
							}
						}
					}
